...
function arlo_tm_animate_text(){
	...
	var animateSpan			= jQuery('.arlo_tm_animation_text_word');
		...
		animateSpan.typed({
			strings: ["Creator", "Freelancer", "Consultant", "Web Designer", "Marketing Guru", "Event Host", "Graphic Designer", "Producer", "Photographer", "Videographer"],
			loop: true,
			startDelay: 1e3,
			backDelay: 2e3
		});
...
function arlo_tm_kenburn_slider(){
	...
	"use strict";
		...
		jQuery(function() {
			...
			slides: [
				{ src: 'img/hero/Downtown-Miami.jpg' },
				{ src: 'img/hero/Downtown-Miami.jpg' },
				{ src: 'img/hero/Downtown-Miami.jpg' },
			]
